...
import com.greenravolution.gravoapp.functions.asyncGetSelectedTransaction;
...
//                TextView tvStatusDetails = findViewById(R.id.tvStatusDetails);
                ...
                if(transactionHistory.length()==1 || transactionHistory.length()==0){
//                    tvStatusDetails.setVisibility(View.GONE);
                }else{
//                    tvStatusDetails.setVisibility(View.VISIBLE);
                }
...
//                    tvStatusDetails.setText(String.format("Item Scheduled to be picked up on %s", transactionObject.getString("collection_date")));
                ...
                if (transactionObject.getString("status_id").equals("1")) {
                    Log.e("Transaction status", transactionObject.getString("status_idF"));
                ...
                cancel.setOnClickListener(v -> {
                    AlertDialog.Builder builder = new AlertDialog.Builder(ActivitySelectedTransaction.this)
                            .setCancelable(false).setMessage("Are you sure you wish to cancel this booking?")
                ...
                reschedule.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        dialog.setTitle("Re-schedule collection");
