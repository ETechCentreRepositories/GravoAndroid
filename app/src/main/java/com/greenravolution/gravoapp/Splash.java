...
import com.greenravolution.gravoapp.login.FacebookAddDetailsActivity;
import com.greenravolution.gravoapp.login.Login;
...
public class Splash extends AppCompatActivity {
        ...
        if (isNetworkAvailable()) {
            ...
            new Handler().postDelayed(() -> {
                ...
                if (sessionManager.getString(SESSION_ID, null) == null) {
                    ...
                    getUser.execute(email,String.valueOf(FirebaseInstanceId.getInstance().getToken()));
    ...
    public class getUser extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            return req.GetRequest("http://www.ehostingcentre.com/gravo/getUsers.php?email=" + strings[0]+"&token="+strings[1]);
        }
