...
import com.greenravolution.gravoapp.MainFragments.Home;
import com.greenravolution.gravoapp.MainFragments.Notifications;
import com.greenravolution.gravoapp.MainFragments.Settings;
import com.greenravolution.gravoapp.MainFragments.Transactions;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionManager = getSharedPreferences(SESSION, Context.MODE_PRIVATE);
        intent = getIntent();
        Log.e("GET INTENT", intent.toString());
        if(intent.getExtras()!=null){
            Bundle bundle = intent.getExtras();
            JSONObject json = new JSONObject();
            Set<String> keys = bundle.keySet();
            for (String key : keys) {
                try {                        // json.put(key, bundle.get(key)); see edit below
